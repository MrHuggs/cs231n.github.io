...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        hidden_out, hidden_cache = affine_relu_forward(conv_out.reshape([N, -1]), W2, b2)
        ...
        da2, dw3, db3 = affine_backward(dout, scores_cache)
        da1, dw2, db2 = affine_relu_backward(da2, hidden_cache)
        da1 = da1.reshape(conv_out.shape)
        _,  dw1, db1 = conv_relu_pool_backward(da1, conv_cache)
